            ...
            <div className="flex-1 p-6 ml-64">
                ...
                <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden flex flex-col md:flex-row ">
                    ...
                    <div className="relative w-full md:w-1/2">
                        <Image
                            src="/images/doctor_male.png" // Change this to the correct image path
                            alt="Dr. Anand Nair"
                            width={400}
                            height={400}
                        ...
                        <div className="absolute bottom-0 bg-blue-600 text-white text-center py-3 w-full">
                            <h2 className="text-xl font-bold">Dr. Anand Nair</h2>
                            <p className="text-sm">Ophthalmologist</p>
                        </div>
                    </div>
                    <div className="p-6 w-1200 md:w-1/2">
                        {/* Profile Section */}
                        <h3 className="text-blue-600 text-lg font-semibold">PROFILE</h3>
                        <p className="text-gray-700 font-bold text-xl">Dr. Anand Nair</p>
                        ...
                        <p className="text-gray-700">English, Hindi, Marathi, German, Malayalam</p>
